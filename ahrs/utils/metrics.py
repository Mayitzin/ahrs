...
def euclidean(x, y, **kwargs):
    ...
    >>> ahrs.utils.metrics.euclidean(angles, noisy)
    2.585672169476804
    >>> ahrs.utils.metrics.euclidean(angles, noisy, axis=0)
    array([1.36319772, 1.78554071, 1.28032688])
    >>> ahrs.utils.metrics.euclidean(angles, noisy, axis=1)     # distance per sample
