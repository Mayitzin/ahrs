...
class TestFrames(unittest.TestCase):
    ...
    def test_enu2ecef(self):
        np.testing.assert_array_almost_equal(ahrs.common.frames.enu2ecef(186.28, 286.84, 939.69, 42, -82, 200), [660930.19515, -4701424.22216, 4246579.60122], decimal=5)
        np.testing.assert_array_almost_equal(ahrs.common.frames.enu2ecef(355601.2616, -923083.1558, 1041016.4238, 45.9132, 36.7484, 1877753.2), [5507528.9, 4556224.1, 6012820.8], decimal=4)
